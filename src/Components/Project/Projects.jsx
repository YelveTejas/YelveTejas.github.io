          ...
          >
            ...
            data-aos-duration='1500'>
                <Box p={3}>
                  <Text letterSpacing={1.5} fontSize='x-large' color='orange.500' fontWeight='semibold'>About Project</Text>
                  <div>
                    <Text fontSize='large'className='project-description' >Chargebee is a subscription management system which can help you handle all the aspects of the subscription life cycle including recurring billing, invoicing and trial management for your customers.</Text>
                  </div>
                  <Text mt={4} fontSize={"x-large"} color="orange.500" fontWeight='semibold'>Tech-Stack</Text>
                  <Text fontSize={'large'} className='project-tech-stack'>
                    HTML | CSS| Javascript 
                  ...
                  <Link className='project-github-link'  href='https://github.com/aks-samanta/Charbee.com_Clone' isExternal>
                  <FaGithub  size={'2rem'}/>
                  </Link>
                  </Flex>
                </Box>
          ...
          >
            ...
            data-aos-duration='1500'>
                <Box p={3}>
                  <Text letterSpacing={1.5} fontSize='x-large' color='orange.500' fontWeight='semibold'>About Project</Text>
                  <div  >
                    <Text fontSize='large' className='project-description'>JioMart is an Indian e-commerce company, headquartered in Navi Mumbai, Maharashtra.The company initially focused on online groceries sales before expanding into other product categories such as fashion, home essentials, and lifestyle products.</Text>
                  </div>
                  <Text mt={4} fontSize={"x-large"} color="orange.500" fontWeight='semibold'>Tech-Stack</Text>
                  <Text fontSize={'large'} className='project-tech-stack'>
                  ...
                  <Link className='project-github-link' href='https://github.com/vishnu9651/rampant-rabbit-487' isExternal>
                  <FaGithub  size={'2rem'}/>
                  </Link>
                  </Flex>
                </Box>
